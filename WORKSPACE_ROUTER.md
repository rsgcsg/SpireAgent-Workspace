...
- Workspace governance, Skills, handoffs, shared-project instructions, knowledge pointers and temporary relay: `rsgcsg/SpireAgent-Workspace`
...
Read `workspace/CURRENT.md`, `workspace/SOURCE_OF_TRUTH.md`, `skills/SKILL_SUITE_MANIFEST.json`, and `workspace/HANDOFF.md`; then refresh the relevant Platform/STPD remote ref before claiming current state.
