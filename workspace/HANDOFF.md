...
The 2026-08-28 Skill/Governance reconciliation makes `skills/releases/<skill-name>/skill.zip` the canonical complete Skill source/release authority and validates archive/version hashes deterministically, and repairs deployment drift. Installed Skill copies remain deployments and must be rolled out separately from a Git merge.
